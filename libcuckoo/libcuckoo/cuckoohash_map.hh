...
public:
  ...
  using key_value_type = typename buckets_t::key_value_type;
  ...
  void del_from_bucket_at_slot(const size_type bucket_ind,
...
public:
  ...
  public:
    ...
    using key_value_type = typename cuckoohash_map::key_value_type;
